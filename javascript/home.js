...
var hr=day.getHours();
if(hr>0 && hr<12){
  document.getElementById("demo").innerHTML="Good Morning,Users";
}

else if(hr>=12 && hr<17){
  document.getElementById('demo').innerHTML="Good Afternoon,Users";
}
else if(hr>17 && hr<19){
  document.getElementById('demo').innerHTML="Good Evening,Users";
}
else{
  document.getElementById('demo').innerHTML="Good Night,Users";
}
